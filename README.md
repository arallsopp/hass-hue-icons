...
hass-hue-icons includes 164 custom icons designed by the author for specific hue fixtures and bulb combinations that aren't represented by the 'official' icon set. Each of these has been hand drawn in Illustrator and proposed in response to a community request. 
...
| ![hue:go-group](https://raw.githubusercontent.com/arallsopp/hass-hue-icons/main/docs/custom_svgs/go-group.svg)| hue:go-group | ![hue:gradient-lightstrip-wrap](https://raw.githubusercontent.com/arallsopp/hass-hue-icons/main/docs/custom_svgs/gradient-lightstrip-wrap.svg)| hue:gradient-lightstrip-wrap |
